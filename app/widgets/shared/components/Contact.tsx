    ...
    return (
        <section>
            <div id='Contact' className='bg-[#1a1a29] text-white py-10'>
                <div>
                    <div className='w-3/4 mx-auto text-3xl font-semibold text-[#7562E0]'>
                    Contact Me
                    </div>
                        {/* <TitleText title='Contact Me' textStyle='text-center' /> */}
                        <form onSubmit={sendEmail} className='w-3/4 mx-auto'>
                            <div className='flex flex-col md:w-3/4 w-full gap-6 my-4'>
                            ...
                            <div className='flex flex-col mt-8 gap-4'>
                                <label htmlFor="message" className='md:w-3/4 w-full text-lg md:text-xl'>Enter your message:</label>
